...
func (dcr *ExchangeWallet) AuditContract(coinID, contract, txData dex.Bytes) (asset.AuditInfo, error) {
	...
	isTreasuryEnabled := contractTx.Version == wire.TxVersionTreasury
	if err = blockchain.CheckTransactionSanity(contractTx, dcr.chainParams, isTreasuryEnabled); err != nil {
